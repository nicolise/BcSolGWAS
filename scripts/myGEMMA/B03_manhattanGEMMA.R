...
myGEMMA <- read.table("data/GEMMA_files/03_GEMMAouts/binMAF20NA10_PLINK_2.assoc.txt", header=TRUE)
...
jpeg(paste("paper/plots/addGEMMA/SlBc_MAF20_10NA_GEMMA_Wild_p.jpg", sep=""), width=8, height=5, units='in', res=600)
