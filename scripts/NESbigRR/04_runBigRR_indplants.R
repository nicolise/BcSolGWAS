...
#2 to 13
#run 2 separately
#all phenos: 2:13. rerun just 8 (LA2176) and 13 (LA0480) separately
...
con <- file("04_bigRRoutput/trueMAF20_10NA/IndPlant_LA0480_Output_c.log")
