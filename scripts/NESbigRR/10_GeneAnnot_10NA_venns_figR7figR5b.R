...
#---------------------------------------------------------------------------------
#plots top 12plants genes
IPlant2 <- read.csv("data/GWAS_files/05_annotation/window2kb/hi12plants_genesTOANNOT.csv")

jpeg("paper/plots/addGEMMA/5b_topGenesOverlap_IndPlants_2kbWin.jpg", width=7.5, height=5, units='in', res=600)
