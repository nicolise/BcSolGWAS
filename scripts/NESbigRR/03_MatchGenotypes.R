...
SNPs <- read.csv("02_csvPrep/hp_binaryMAF5.csv", row.names = 1)
...
#save them files
write.csv(SNPMatch2, "03_bigRRinput/binSNP_bigRR_MA5hp.csv")
write.csv(PhenoMatch2, "03_bigRRinput/Sl_Pheno_bigRR_MAF5.csv")
#------------------------------------------------------------------------------
#extra things
