...
HEMdat <- read.csv("NewModel0711/Sl_LesionSize_MAF10.HEM.csv")
...
write.csv(HEMdat3, "NewModel0711/Sl_LesionSize_MAF10.HEM.PlotFormat.csv") 
write.csv(HEMthresh, "NewModel0711/Sl_LesionSize_MAF10.HEM.Thresh.csv")
#read in to 06_plots