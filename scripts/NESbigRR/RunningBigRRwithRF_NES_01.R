...
#should I remove reference (B05.10) phenotypes and genotypes from list?
...
write.csv(rbind(thresh.BLUP$"0.95Thresh",thresh.BLUP$"0.975Thresh",thresh.BLUP$"0.99Thresh",thresh.BLUP$"0.999Thresh",outpt.BLUP),"Sl_LesionSizePoisson.BLUP.csv")
write.csv(rbind(thresh.HEM$"0.95Thresh",thresh.HEM$"0.975Thresh",thresh.HEM$"0.99Thresh",thresh.HEM$"0.999Thresh",outpt.HEM),"Sl_LesionSizePoisson.HEM.csv")

#This part failed for me -- NES : Line 122 to 143
...
write.csv(rbind(thresh.HEM$"0.99Thresh",sig.HEM),"Sl_LesionSizePoisson.HEM.99Sig.csv")
