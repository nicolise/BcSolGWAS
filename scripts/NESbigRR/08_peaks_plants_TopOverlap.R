...
#NOW only keep top 50 SNPs per plant, AND only over threshold
#LA0410: 0.999
HEM.LA0410 <- subset(HEM.plotdata, abs(LA410) > 0.01, 
...
#LA0480: 0.999
HEM.LA0480 <- subset(HEM.plotdata, abs(LA480) > 0.01, 
...
#LA1589: 0.999
HEM.LA1589 <- subset(HEM.plotdata, abs(LA1589) > 0.01, 
...
#LA1684: 0.999
HEM.LA1684 <- subset(HEM.plotdata, abs(LA1684) > 0.01, 
...
#LA2093: 0.999
HEM.LA2093 <- subset(HEM.plotdata, abs(LA2093) > 0.01, 
...
#LA2176: 0.999
HEM.LA2176 <- subset(HEM.plotdata, abs(LA2176) > 0.01, 
...
#LA2706: 0.999
HEM.LA2706 <- subset(HEM.plotdata, abs(LA2706) > 0.01, 
...
HEM.LA3008 <- subset(HEM.plotdata, abs(LA3008) > 0.01,
...
#LA3475: 0.95
HEM.LA3475 <- subset(HEM.plotdata, abs(LA3475) > 0.01,
...
#LA4345: 0.999
HEM.LA4345 <- subset(HEM.plotdata, abs(LA4345) > 0.01, 
...
HEM.LA4355 <- subset(HEM.plotdata, abs(LA4355) > 0.01, 
...
write.csv(Top50SNP, "data/GWAS_files/05_annotation/CommonSNPpeaks_IndPlants.csv")
