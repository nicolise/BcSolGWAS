...
Top50SNP.wide.DM <- read.csv("results/Domestication_Top50SNP_SegWide.csv")
#remove X column
...
jpeg("plots/MultiPlot/meta/FigR8_Sl_MAF20_meta.ManhattanPlot.jpg", width=8, height=4, units='in', res=600)
  ggplot(Top50SNP.all.w)+
    ...
    geom_point(aes(x=Index, y=(PlantPhenos.Domest), color = "Domestication"), alpha=1/2)+
...
jpeg("plots/MultiPlot/meta/FigR9_Sl_MAF20_Domestmeta.ManhattanPlot.jpg", width=6.5, height=2.25, units='in', res=600)
