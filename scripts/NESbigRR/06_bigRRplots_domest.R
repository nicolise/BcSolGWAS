...
#without the loop [4]
jpeg(paste("plots/MultiPlot/trueMAF/SlBc_trueMAF20_highTR_manhattan",names(HEM.plotdata[4]),".jpg", sep=""), width=8, height=4, units='in', res=600)
ggplot(HEM.plotdata, aes(x=Index, y=HEM.plotdata[4]))+
  ...
  geom_text(aes(-0.01,get(paste("TH999pos_", names(HEM.plotdata[4]), sep="")), label =
